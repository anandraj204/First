...
namespace Jane.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            {
                ViewBag.token = Request.Cookies["usertoken"].Value.ToString();
            }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new User { UserName = model.Email, Guid = System.Guid.NewGuid().ToString(), Email = model.Email, PasswordHash = "AOP3vxwFZmwhJu+j/kruoTddJM9kA5RxynYBaLgjb+d9BDlTjjzv4DcxcYqDaR1Jmw==" };
